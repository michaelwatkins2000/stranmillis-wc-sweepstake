...
export const bracket = {
  // Order below reflects the official FIFA bracket lineage (verified against
  // en.wikipedia.org/wiki/2026_FIFA_World_Cup_knockout_stage's Bracket section
  // and per-match "Winner Match N" feeder references), not chronological
  // kick-off order. Consecutive pairs here are drawn as connector lines into
  // the next round by Knockout.jsx's pairUp() — so array position determines
  // tree structure, not just display order.
  r32: [
    ...
    { id: "r32_2",  apiId: 537418, date: "2026-06-30", time: "02:00", homeLabel: "1st Group C",   awayLabel: "2nd Group F",     home: "Netherlands", away: "Morocco", homeScore: 3, awayScore: 4 },
    ...
    { id: "r32_4",  apiId: 537416, date: "2026-06-30", time: "22:00", homeLabel: "2nd Group E",   awayLabel: "2nd Group I",     home: "France", away: "Sweden", homeScore: 3, awayScore: 0 },
    { id: "r32_5",  apiId: 537419, date: "2026-07-03", time: "00:00", homeLabel: "1st Group H",   awayLabel: "2nd Group J",     home: "Portugal", away: "Croatia", homeScore: 2, awayScore: 1 },
    { id: "r32_6",  apiId: 537420, date: "2026-07-02", time: "20:00", homeLabel: "2nd Group K",   awayLabel: "2nd Group L",     home: "Spain", away: "Austria", homeScore: 3, awayScore: 0 },
    { id: "r32_7",  apiId: 537421, date: "2026-07-02", time: "01:00", homeLabel: "1st Group G",   awayLabel: "3rd A/E/H/I/J",   home: "USA", away: "Bosnia & Herzegovina", homeScore: 2, awayScore: 0 },
    ...
    { id: "r32_12", apiId: 537426, date: "2026-07-01", time: "17:00", homeLabel: "1st Group L",   awayLabel: "3rd E/H/I/J/K",   home: "England", away: "DR Congo", homeScore: 2, awayScore: 1 },
    { id: "r32_13", apiId: 537427, date: "2026-07-03", time: "23:00", homeLabel: "1st Group K",   awayLabel: "3rd D/E/I/J/L",   home: "Argentina", away: "Cape Verde", homeScore: 3, awayScore: 2 },
    { id: "r32_14", apiId: 537428, date: "2026-07-03", time: "19:00", homeLabel: "1st Group J",   awayLabel: "2nd Group H",     home: "Australia", away: "Egypt", homeScore: 3, awayScore: 5 },
    { id: "r32_15", apiId: 537429, date: "2026-07-03", time: "04:00", homeLabel: "1st Group B",   awayLabel: "3rd E/F/G/I/J",   home: "Switzerland", away: "Algeria", homeScore: 2, awayScore: 0 },
    { id: "r32_16", apiId: 537430, date: "2026-07-04", time: "02:30", homeLabel: "2nd Group D",   awayLabel: "2nd Group G",     home: "Colombia", away: "Ghana", homeScore: 1, awayScore: 0 },
  ],
  r16: [
  ...
  sf: [
    { id: "sf_1", apiId: 537387, date: "2026-07-14", time: "20:00", home: "France", away: "Spain", homeScore: 0, awayScore: 2 },
    { id: "sf_2", apiId: 537388, date: "2026-07-15", time: "20:00", home: "England", away: "Argentina", homeScore: 1, awayScore: 2 },
  ],
  final: [
    { id: "final", apiId: 537390, date: "2026-07-19", time: "20:00", home: "Spain", away: "Argentina", homeScore: null, awayScore: null },
  ],
}
